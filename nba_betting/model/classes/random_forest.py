...
class RandomForestSub(RandomForestClassifier):  # type: ignore[misc]
    ...
    def score(
        ...
        return super(RandomForestSub, self).score(self.transform_X(X), y, sample_weight)
...
class DefenceRandForest(RandomForestSub):
    ...
    model_colums = ["DREB", "STL", "BLK", "OPP_OREB", "PF"]
...
class OffenceRandForest(RandomForestSub):
    ...
    model_colums = ["PTS", "FGM", "FG3M", "FTM", "OREB", "AST", "TOV", "OPP_DREB"]
...
class GeneralRandForest(RandomForestSub):
    model_name = "general_random_forest"
    model_colums = ["PTS", "OPP_PTS", "PF", "PLUS_MINUS", "OPP_PLUS_MINUS"]
    ...
    def __init__(
        ...
        super(GeneralRandForest, self).__init__(
            transform_X=GeneralRandForest.transform_X,
            n_estimators=n_estimators,
            criterion=criterion,
            max_depth=max_depth,
            min_samples_split=min_samples_split,
